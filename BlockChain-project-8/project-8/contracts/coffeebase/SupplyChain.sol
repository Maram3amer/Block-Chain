...
import '../coffeeaccesscontrol/SellerRole.sol';

// Define a contract 'Supplychain'
contract SupplyChain is ConsumerRole, FarmerRole, SellerRole {
  ...
  function addItem(uint _upc, address _originFarmerID, string _originFarmName, string _originFarmInformation,
    string  _originFarmLatitude, string  _originFarmLongitude, string  _productNotes, uint productPrice)   public
    onlyFarmer()
  {
    // Add the new item
    items[_upc] = Item({
  ...
  // Use the above modifers to check if the item is forSale
    ...
    // Access Control List enforced by calling Smart Contract / DApp
{
    ...
    items[_upc].sellerID = msg.sender;
    // Emit the appropriate event
    emit Received(_upc);
  }

  // Define a function 'buyItem' that allows the seller to mark an item 'Bought'
  // Use the above defined modifiers to check if the item is received , if the consumer has paid enough,
